<x-app title="Tambah Karyawan">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px;">
        <div>
            <p style="font-size:.9rem;opacity:.75;">Isi data karyawan baru yang akan didaftarkan ke sistem.</p>
        </div>
        <a href="{{ route('hr.employees.index') }}" style="font-size:.9rem;padding:6px 10px;border-radius:999px;border:1px solid #d1d5db;text-decoration:none;color:#111827;">
            ← Kembali
        </a>
    </div>

    <form class="card" method="POST" action="{{ route('hr.employees.store') }}" style="max-width:520px;">
        @csrf
        ...
        <div style="margin-top:16px;font-size:.8rem;opacity:.7;">
