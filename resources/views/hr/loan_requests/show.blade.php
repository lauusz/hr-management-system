            ...
            <div class="section">
                ...
                <div class="card">
                    ...
                    <div class="document-link">
                        @if($isImageDoc)
                        <button type="button" class="doc-preview" data-image-viewer-src="{{ $docUrl }}" data-image-viewer-alt="Dokumen Pendukung" style="border:none;width:100%;padding:0;background:transparent;display:block;text-align:left;">
