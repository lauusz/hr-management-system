<x-app title="Tambah Divisi">
    ...
    <div class="form-container">
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    <h2 class="form-title">Tambah Divisi Baru</h2>
                    <p class="form-subtitle">Buat divisi baru dan tentukan supervisor bila diperlukan.</p>
                </div>
            ...
            <form method="POST" action="{{ route('hr.divisions.store') }}" class="form-content">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <small class="helper-text">Opsional. Anda dapat menentukannya nanti.</small>
                </div>
    ...
    <style>
        /* Container Layout */
        .form-container {
            max-width: 550px; /* Lebih kecil karena formnya simple */
            margin: 0 auto;
            padding-bottom: 40px;
        }
