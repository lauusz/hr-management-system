    ...
    <div class="div-create-container">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <p class="page-subtitle">Perbarui nama divisi dan supervisor yang bertanggung jawab.</p>
            </div>
        </div>

        {{-- Form Card --}}
        <div class="form-card">
            <form method="POST" action="{{ route('hr.divisions.update', $item->id) }}" class="form-layout">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <small class="form-hint">Supervisor bertanggung jawab untuk menyetujui izin anggota divisi.</small>
                </div>
