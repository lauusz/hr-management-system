<x-app title="Master Shift Kerja">
    ...
    <div class="card" style="margin-bottom:12px;display:flex;justify-content:space-between;align-items:center;gap:8px;flex-wrap:wrap;">
        <div style="font-size:0.9rem;opacity:.7;">
            Master Shift digunakan untuk mengatur pola jam kerja per hari.
        </div>
            ...
            <table style="width:100%;min-width:720px;border-collapse:collapse;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:right;padding:10px 12px;border-bottom:1px solid #e5e7eb;font-size:0.8rem;font-weight:600;text-transform:uppercase;letter-spacing:.04em;color:#6b7280;width:170px;">
                            Aksi
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid #f3f4f6;">
                        ...
                        <td style="padding:10px 12px;vertical-align:middle;">
                            @if($sh->is_active)
                            <span style="display:inline-flex;align-items:center;padding:2px 8px;border-radius:999px;background:#dcfce7;color:#166534;font-size:0.75rem;">
                                Aktif
                            </span>
                            @else
                            <span style="display:inline-flex;align-items:center;padding:2px 8px;border-radius:999px;background:#f3f4f6;color:#4b5563;font-size:0.75rem;">
                                Nonaktif
                            </span>
                            @endif
                        </td>
