<x-app title="Izin / Cuti">
    ...
    <div style="margin-bottom:12px;display:flex;justify-content:space-between;align-items:center;gap:8px;flex-wrap:wrap;">
        <div style="opacity:.7;font-size:.9rem;">
            Daftar pengajuan izin/cuti Anda yang tercatat di sistem.
        </div>

        <a href="{{ route('leave-requests.create') }}"
           style="padding:6px 12px;border-radius:999px;background:#1e4a8d;color:#fff;
    ...
    <div class="card" style="margin-bottom:14px;">
        <form method="GET" action="{{ route('leave-requests.index') }}" style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap;">
                    ...
                    @forelse($items as $i => $row)
                        ...
                        <tr style="border-bottom:1px solid #f3f4f6;">
                            ...
                            <td style="padding:10px 12px;vertical-align:middle;text-align:right;">
                                <a href="{{ route('leave-requests.show', $row) }}"
