<x-app title="Presensi Pulang">
    <x-slot name="header">
        <div class="section-header-inline">
            ...
            <div>
                <h1 class="section-title">Presensi Pulang</h1>
    ...
    <x-modal id="clockout-success" title="Berhasil!" variant="success" type="info" cancelLabel="Tutup">
        <div style="text-align: center;">
            ...
            <p style="font-size: 1.0625rem; font-weight: 700; color: var(--text-primary, #111827); margin: 0 0 4px;">Presensi Pulang Tercatat</p>
            <p style="font-size: 0.8125rem; color: var(--text-muted, #6B7280); margin: 0;">Terima kasih, hati-hati di jalan!</p>
        </div>
    </x-modal>
