...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('remote-attendance')->name('remote-attendance.')->group(function () {
        ...
        Route::get('/purpose', [AttendanceController::class, 'remotePurpose'])->name('purpose');
        Route::get('/photo', [AttendanceController::class, 'remotePhoto'])->name('photo');
        Route::get('/clock-out', [AttendanceController::class, 'showRemoteClockOutForm'])->name('clockOut.form');
    ...
    Route::middleware('role:HRD,HR STAFF')->group(function () {
        ...
        Route::prefix('hr/supervisors')->name('hr.supervisors.')->group(function () {
            ...
            Route::get('/{user}', [SupervisorDataController::class, 'show'])->name('show');
            Route::patch('/{user}/off-spv-periods/{period}', [SupervisorDataController::class, 'updateOffSpvPeriod'])
                ->name('off-spv-periods.update');
            Route::post('/{user}/off-spv-history', [SupervisorDataController::class, 'storeHistoricalOffSpv'])
                ->name('off-spv-history.store');
