<x-app title="Edit PT">
    ...
    <div class="pt-container">
        ...
        <div class="page-header">
            ...
            <div>
                <h1 class="page-title">Edit Perusahaan (PT)</h1>
                <p class="page-subtitle">Perbarui informasi nama perusahaan yang terdaftar.</p>
            </div>
        </div>

        {{-- Form Card --}}
        <div class="form-card">
            <form method="POST" action="{{ route('hr.pts.update', $item->id) }}" class="form-layout">
                @csrf
                @method('PUT')
