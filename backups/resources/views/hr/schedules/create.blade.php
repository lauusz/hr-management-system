        ...
        <div class="card">
            <div class="card-header">
                <div>
                    ...
                    <p class="form-subtitle">Atur shift dan lokasi presensi untuk karyawan.</p>
                </div>
            ...
            <form action="{{ route('hr.schedules.store') }}" method="POST" class="form-content">
                @csrf
                ...
                <div class="form-group">
                    ...
                    @if($selectedUser)
                        ...
                        <small class="helper-text">Karyawan dipilih otomatis.</small>
                    @else
