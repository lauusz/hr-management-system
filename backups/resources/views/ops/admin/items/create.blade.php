<x-ops-app title="Tambah Barang OPS">
    ...
    <form method="POST" action="{{ route('v2.ops.admin.items.store') }}" enctype="multipart/form-data" class="ops-card ops-form-grid">
        @csrf
        ...
        <div><label class="ops-label" for="image">Foto barang (opsional)</label><input class="ops-input" id="image" type="file" name="image" accept="image/*,.heic,.heif"></div>
